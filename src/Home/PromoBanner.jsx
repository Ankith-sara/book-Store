        ...
        <div className='mt-16 py-16 bg-teal-100 px-4 lg:px-24'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-12'>
                <div className='md:w-1/2'>
                    <h2 className='text-4xl font-bold mb-6 leading-snug'>2023 National Book Awards for Ficition Finalist!</h2>
                ...
                <div>
                    <img src={bookPic} alt="Award winning book" className='w-96' />
                </div>
            </div>
        </div>
    )
